...
VALUES 
('그로브동산', '강원', '펜션', '유럽과 일본의 호스텔 문화를 동경해온 세 명의 친구가 여행자의 도시 양양에 국내 최초로 디자인 관점의 호스텔을 만들었습니다. 디자인 그룹 지랩을 비롯하여 다양한 브랜드의 협업으로 탄생한 그로브동산은 바스터즈 카페 캡슐형 베드 코인시스템 등으로 브랜딩하여 순천을 찾는 20~30대 여행자들에게 새로운 사용자 경험을 제공하는 열린 공간으로서 활발히 운영되고 있습니다.', '양양', 3, 50000, 'img/main8.jpg','동산리 해변 옆 몽환적인 로지'),
