...
(
	...
	room_summary varchar(80) NOT NULL,
...
('토리코티지', '제주', '민박', '제주시 조천읍에 있는 토리코티지X하시시박은 독특한 색감 영감을 구현해내는 포토그래퍼 하시시박과 콜라보레이션으로 완성된 곳입니다. 하얀 벽의 이색적인 구조물로 엔트런스를 길게 만들어 천천히 걸어오며 둘러볼 수 있도록 의도하였습니다.', '제주', 4, 550000, 'img/main17.jpg','너른 대지 위 연속적인 동선과 흐름을 마주하다'),
