    ...
    <div class="container mt-3">
        ...
        <form name="frm" action="write" method="post"
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="subject" placeholder="제목을 입력하세요" name="qna_subject" required>
            </div>
            <div class="mb-3 mt-3">
                <label for="content">내용:</label>
                <textarea class="form-control" rows="5" id="content" placeholder="내용을 입력하세요" name="qna_content"></textarea>
            </div>
